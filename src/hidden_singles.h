...
void find_hidden_single_cells(Cell **p_cells, HiddenSingle *p_hidden_singles, int *p_counter);

// eliminate overlapped cases
int overlapped_candidates(HiddenSingle *p_hidden_singles, int *counter);
